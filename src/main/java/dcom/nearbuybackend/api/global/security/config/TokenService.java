...
public class TokenService {
    ...
    private String secretKey = "API Server For NearBuy(Neighborhood Trading Web Service)";
    ...
    public Token generateToken(String id) {
        ...
        long refreshTokenPeriod = 1000L * 60L * 60L * 24L * 30L; // 7일
    ...
    public Token generateOnlyAccessToken(String id) {
    ...
    // Token으로부터 id 추출 후 데이터베이스에 해당하는 유저 반환
